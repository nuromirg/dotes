...
theme.taglist_bg_focus = '#808080cc'
...
theme.tasklist_bg_focus = '#808080cc'
...
-- table.insert(theme.parent_filter_list, swal_ignore)

-- theme.child_filter_list = {} -- class names list that should not swallow their parents
-- table.insert(theme.child_filter_list, swal_ignore)
